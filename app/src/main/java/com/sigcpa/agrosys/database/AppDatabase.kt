    ...
    companion object {
        ...
        private fun insertInitialData(db: SupportSQLiteDatabase) {
            ...
            try {
                ...
                db.execSQL("INSERT INTO catalogo_cultivos (nombre, nombre_cientifico, tipo_ciclo, dias_a_cosecha_promedio, created_at, sincronizado) VALUES ('Maíz', 'Zea mays', 'ciclo_corto', 120, $now, 1)")
                db.execSQL("INSERT INTO catalogo_cultivos (nombre, nombre_cientifico, tipo_ciclo, dias_a_cosecha_promedio, created_at, sincronizado) VALUES ('Papa', 'Solanum tuberosum', 'ciclo_corto', 150, $now, 1)")
                db.execSQL("INSERT INTO catalogo_cultivos (nombre, nombre_cientifico, tipo_ciclo, dias_a_cosecha_promedio, created_at, sincronizado) VALUES ('Palta', 'Persea americana', 'perenne', NULL, $now, 1)")
                db.execSQL("INSERT INTO catalogo_cultivos (nombre, nombre_cientifico, tipo_ciclo, dias_a_cosecha_promedio, created_at, sincronizado) VALUES ('Café', 'Coffea arabica', 'perenne', NULL, $now, 1)")
                db.execSQL("INSERT INTO catalogo_cultivos (nombre, nombre_cientifico, tipo_ciclo, dias_a_cosecha_promedio, created_at, sincronizado) VALUES ('Tomate', 'Solanum lycopersicum', 'ciclo_corto', 90, $now, 1)")
