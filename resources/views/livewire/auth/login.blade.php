<div class="min-h-screen w-full relative overflow-hidden bg-black font-sans flex items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-[1600px] mx-auto h-screen flex flex-col lg:flex-row items-center justify-center px-6 md:px-20 gap-10">
        ...
        <!-- Right Section: Login & Icons (Always Visible) -->
        <div class="flex flex-col items-center justify-center w-full max-w-[450px] animate-in fade-in zoom-in duration-1000">
            ...
            <div class="w-full bg-black/40 backdrop-blur-3xl border border-white/10 rounded-[4rem] p-10 md:p-14 shadow-[0_50px_100px_-20px_rgba(0,0,0,1)] transition-all duration-700 hover:border-white/20 relative overflow-hidden">
                ...
                <div class="text-center mb-10">
                    ...
                    <p class="text-white/30 text-[10px] font-black uppercase tracking-[0.4em] italic">Iniciar Sesión</p>
                ...
                <form wire:submit="login" class="space-y-6">
                    ...
                    <div class="relative">
                        <div class="flex items-center bg-[#eef2f7] rounded-xl overflow-hidden shadow-inner h-14 border-b-4 border-agri-green transition-all">
                            ...
                            <input wire:model="form.email"
                                   ...
                                   required
                                   autofocus
                                   placeholder="raul@agrosys.com"
                                   class="flex-1 bg-transparent border-none text-slate-800 text-sm focus:ring-0 outline-none px-4 font-bold placeholder:text-slate-400">
                        </div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        <div class="flex items-center bg-[#eef2f7] rounded-xl overflow-hidden shadow-inner h-14 border-b-4 border-slate-300 focus-within:border-agri-green transition-all">
                            ...
                            <button type="button"
                                    @click="show = !show"
                                    class="w-10 h-full flex items-center justify-center text-slate-300 hover:text-agri-green transition-colors">
                    ...
                    <!-- Action Button -->
                    <button type="submit"
                            class="w-full py-3.5 bg-agri-green text-white rounded-full font-black uppercase text-[14px] tracking-[0.3em] shadow-[0_20px_40px_-10px_rgba(0,186,46,0.5)] hover:scale-105 active:scale-95 transition-all mt-6 relative overflow-hidden group/btn italic">
                    ...
                    <div class="text-center pt-2">
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-[12px] font-black text-white/20 hover:text-agri-green uppercase tracking-[0.3em] transition-colors italic" wire:navigate>
                ...
                <div class="mt-8 text-center border-t border-white/5 pt-8">
                    <p class="text-[12px] text-white/20 font-black uppercase tracking-[0.2em]">
                        ¿Nuevo miembro?
                        <a href="{{ route('register') }}" class="text-agri-green font-black ml-2 hover:underline tracking-widest italic" wire:navigate>Únete ahora</a>
                    </p>
                </div>
            </div>
